...
names(unique_listings_dh)<-c("airbnb_id")
...
dh_not_in_ia$name <- ""
dh_not_id_ia$host_name <- ""
dh_not_id_ia$neighbourhood_group <- ""
dh_not_id_ia$neighbourhood <- ""
dh_not_id_ia$last_review <- ""
dh_not_id_ia$reviews_per_month <- ""
dh_not_id_ia$calculated_host_listings_count <- ""
dh_not_id_ia$availability_365 <- ""
