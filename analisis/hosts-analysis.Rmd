...
# local_activo <- read.delim("../../valencia2/data/original/airbnb/190227/listings_valencia_insideairbnb.csv",sep = ",")
...
labs(title=paste("Anuncios en ", local_activo_name, " por tipo de alojamiento y host", sep = ""),
     subtitle = "Datos: InsideAirbnb 2018-09-11",
     caption = caption_1,
...
labs(title=paste("Anuncios por tipo de alojamiento y número de anuncios gestiona host", sep = ""),
     subtitle = paste("Airbnb en ",local_activo_name,". Datos: InsideAirbnb 2018-09-11",sep=""),
     caption = caption_1,
     color="Tipo alojamiento")  +
guides(colour = guide_legend(override.aes = list(size=3))) +
...
labs(title=paste("Top 5 anfitriones según número alojamientos", sep = ""),
     subtitle = paste(local_activo_name,". ",fecha_mes,sep = ""),
     caption = caption_2)  +
guides(colour = guide_legend(override.aes = list(size=3))) +
  facet_wrap(~host_id+host_name, labeller = label_wrap_gen(multi_line=FALSE))
...
# luego con imagemagick hacer mosaico
